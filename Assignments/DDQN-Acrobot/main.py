import gym
import argparse
from ddqn_agent import DoubleDeepQNetworkAgent

ENV = 'Acrobot-v1'
MODEL_PATH = './saved_models/ddqn-final.model'
BEST_MODEL_PATH = './saved_models/ddqn-best_model.model'
TRAIN_EPISODES = 1000
TEST_EPISODES = 10
MEMORY_SIZE = 10000
NUM_CHECKPOINTS = 10
...
def train():
    model = DoubleDeepQNetworkAgent(env = env, train_flag = True, model_path = MODEL_PATH, memory_size = MEMORY_SIZE,\
...
def test():
    model = DoubleDeepQNetworkAgent(env, train_flag = False, model_path = BEST_MODEL_PATH, num_episodes = TEST_EPISODES)
